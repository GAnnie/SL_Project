...
{
    private static PlayerSettingTool win = null;
    private static bool isExport = false;

	[MenuItem("Tools/PlayerSettingTool",false,0)]
    public static void ShowWin()
    {
        isExport = false;
        if( win == null )
		{
			win = (PlayerSettingTool)EditorWindow.GetWindow(typeof(PlayerSettingTool));
		}
		else
		{
			win.Show();
    ...
    public static void ShowWinWithExport( SettingCallBack func)
    {
		...
		EditorWindow.GetWindow(typeof(PlayerSettingTool));
    }
	...
	private GameType gameType = GameType.H1;
   ...
   // private ClientSetMode clientMode = ClientSetMode.ClientMode_Test;
    ...
    private void  GetGameSettingData()
    {
        ...
        {
			Dictionary<string, object> obj = EditorHelper.GetJsonFile(gamesettingDataPath + gamesettingJsonFile, false);
    ...
    private void SaveGameSettingData()
    {
        if (data != null)
        {
            ...
            if (obj != null)
            {
				EditorHelper.SaveJsonFile(obj, gamesettingDataPath + gamesettingJsonFile, false);
            }
        }
...
//		}		
...
#if UNITY_4_6_4
		PlayerSettings.shortBundleVersion = Version.shortBundleVersion;
#endif
    }
	...
	private void ChangeProductName(){
		...
		PlayerSettings.productName = "仙灵世界";
	}
	...
	{
#if UNITY_IPHONE
		return "com.baoyugame.h13d.ios.";
#elif UNITY_ANDROID
		return "com.baoyugame.h13d.android.";
#else
		return "";
#endif
	}
...
//#endif
	...
	private void ChangStreammingAssetPath(GameLoadMode loadMode)
	{
		...
		if( loadMode == GameLoadMode.Local_Packet_Assets)
		{
	...
	private void BulidTarget(int comeFrom)
	{
		...
		string comeFromStr = Version.GetComeFrom();

		//H1_0.2.15.9371_Develop_all.apk
		app_name = "H1" +"_" +  PlayerSettings.bundleVersion + "_" + gameMode + "_" + gameLoadModeStr;
		...
		//H1_Develop_test_0.2.15.9371_20150509_1107_all.apk
	...
	private static string exportPath = "Export" + platformDir;
    ...
    {
		byte[] resourceData =  EditorHelper.GetFileBytes( path, false  );
		...
		if( resourceData != null )
		{
			...
			//生成ResourceVersion
			Dictionary< string , object > resVerObj =  EditorHelper.GetJsonFile( resVersionDataBytes, true );
			...
			Dictionary< string , object > refListObj =  EditorHelper.GetJsonFile( assetRefListBytes, true );
			...
			resVersionDataBytes = EditorHelper.GetJsonFileByte( resVerObj, true );
...
//        Dictionary<string, object> obj = parser.SerializeJson_ResourcesVersionData(data);
	//        EditorHelper.SaveJsonFile(obj, destPath, true);
//    }
//	
    ...
    private void _SaveResourceData( byte[] buff,  string rootPath, string assetPath)
    {
		...
		EditorHelper.SaveFileByte( buff, destPath );
    }
