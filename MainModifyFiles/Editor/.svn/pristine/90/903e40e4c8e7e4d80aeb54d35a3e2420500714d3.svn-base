...
public class AudioController_Editor : EditorEx
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if ( globalFoldout = EditorGUILayout.Foldout( globalFoldout, "Global Audio Settings", foldoutStyle ) )
        {
            ...
            EditBool( ref AC.Persistent, "Persist Scene Loading", "A none-persisting AudioController will get destroyed when loading the next scene." );
            ...
            EditPrefab( ref AC.AudioObjectPrefab, "Audio Object Prefab", "You must specify a prefab here that will get instatiated for each played audio. This prefab must contain the following components: AudioSource, AudioObject, PoolableObject." );
            ...
            if ( curCat != null )
            {
                ...
                if ( itemFoldout = EditorGUILayout.Foldout( itemFoldout, "Audio Item Settings", foldoutStyle ) )
                {
                    ...
                    if ( curItem != null )
                    {
                        ...
                        {
                            EditInt( ref curItem.loopSequenceCount, "   Stop after subitems", "Playing will stop after this number of different subitems were played " );
