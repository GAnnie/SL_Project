...
public class ParticleScaler : MonoBehaviour 
{
	...
	private bool mInFrontOfNGUI = false;
	...
	public bool InFrontOfNGUI 
	{
		get { return mInFrontOfNGUI; }
		set {
			if (mInFrontOfNGUI == value)
				return;

			mInFrontOfNGUI = value;

			ParticleSystem[] mParticleSystems = GetComponentsInChildren<ParticleSystem>();
			foreach(ParticleSystem system in mParticleSystems)
			{
				system.renderer.sharedMaterial.renderQueue = (mInFrontOfNGUI) ? 3001 : 0;
			}
		}
	}
