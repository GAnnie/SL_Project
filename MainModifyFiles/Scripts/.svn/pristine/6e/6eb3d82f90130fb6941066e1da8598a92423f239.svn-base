...
namespace Qiniu.Conf
{
    public class Config
    {
        ...
        /// 七牛提供的公钥，用于识别用户
        /// </summary>
		public static string ACCESS_KEY = "SPA1F5RmqmxDHNAaxxt3hfwLphlOqumjQnafXknl";//"<Please apply your access key>";
        /// <summary>
        /// 七牛提供的秘钥，不要在客户端初始化该变量
        /// </summary>
		public static string SECRET_KEY = "BZ573NuvRFnv-uvhElgTAf-uBoDg5LkYYK3ur2DM";//"<Dont send your secret key to anyone>";
        #endregion
        #region 七牛服务器地址
        /// <summary>
        /// 七牛资源管理服务器地址
		...
		//public static string UP_HOST = "http://kdtsgameprivate.qiniudn.com";//"http://upload.qiniu.com";
        /// <summary>
        /// 七牛资源列表服务器地址.
        /// </summary>
